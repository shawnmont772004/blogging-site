    ...
    <div className=" flex justify-center mt-12 mb-12">
      <div className="bg-white md:w-1/3 w-96 rounded-lg text-black flex flex-col mx-auto gap-4">
        ...
        <form className="flex mx-auto flex-col w-64 gap-4">
          <input type="text" placeholder="first name" className="border rounded-md p-1 border-slate-800 focus:outline-none hover:bg-opacity-80"/>
          <input type="text" placeholder="last name" className="border rounded-md p-1 border-slate-800 focus:outline-none hover:bg-opacity-80"/>
          <input type="text" placeholder="user name" className="border rounded-md p-1 border-slate-800 focus:outline-none hover:bg-opacity-800"/>
          ...
          <input type="tel" placeholder="phone number" className="border rounded-md p-1 border-slate-800 focus:outline-none hover:bg-opacity-80"/>
